...
namespace Nioh2Patcher
{
    ...
    public class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            patches.Add(new Patch(0xB, new byte[] { 0x8, 0x1C, 0x4A }, new byte[] { 0x48, 0x8B, 0xCA, 0xF3, 0x48, 0xF, 0x2C, 0xC0, 0x48, 0x5, 0x0, 0x0, 0x90, 0xC }));
            ...
            patches.Add(new Patch(0xC, new byte[] { 0xF4, 0x20 }, new byte[] { 0xC7, 0x44, 0x24, 0x20, 0x18, 0x0, 0x0, 0x0, 0x41, 0xB9, 0x0, 0x0, 0xF8, 0x15 }));
